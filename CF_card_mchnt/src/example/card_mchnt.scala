...
object card_machnt {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val alsExplicit = new ALS().setMaxIter(5).setRegParam(0.01).setUserCol("card_no_idx"). setItemCol("mchnt_cd_idx").setRatingCol("rating")
    ...
    predictionsImplicit.selectExpr(cols:_*).rdd.map(_.mkString(",")).saveAsTextFile("xrli/credit/CF_results")
